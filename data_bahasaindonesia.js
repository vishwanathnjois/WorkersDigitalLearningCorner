$(document).ready(function () {
    ...
    document.getElementById("wdlc31").text = "Pengetahuan Manajemen Gudang";
    document.getElementById("wdlc32").text = "Pusat Distribusi Pintar";
    document.getElementById("wdlc33").text = "Transportasi";
    ...
    document.getElementById("wdlc51").text = "Optimasi proses ETO";



    document.getElementById("wdlc61").text = "Kepuasan Pelanggan dan Kualitas";
    document.getElementById("wdlc62").text = "Kesehatan & Keamanan";
    document.getElementById("wdlc63").text = "Industrialisasi";
    document.getElementById("wdlc64").text = "Logistik";
    document.getElementById("wdlc65").text = "Manufaktur";
    document.getElementById("wdlc66").text = "Semua";


    document.getElementById("wdlc71").text = "Bersama, Kita Maju!";
    document.getElementById("wdlc72").text = "Komunikasi dan Saya";
    document.getElementById("wdlc73").text = "Agen Perubahan";
    document.getElementById("wdlc74").text = "Rahasia Kebahagiaan";
    document.getElementById("wdlc75").text = "Perlengkapan Awal Pengusaha";


    document.getElementById("wdlc81").text = "goFluent";
    document.getElementById("wdlc82").text = "Belajar Bahasa Inggris";
    document.getElementById("wdlc83").text = "Belajar Bahasa Spanyol";
    document.getElementById("wdlc84").text = "Belajar Bahasa Perancis";



    document.getElementById("wdlc91").text = "Microsoft Office 365";
    document.getElementById("wdlc95").text = "Kemampuan Komputer";
    document.getElementById("wdlc96").text = "Kemampuan Digital";
    document.getElementById("wdlc97").text = "Dasar-dasar Komputer";



    document.getElementById("wdlc101").text = "My LearningLink";
    document.getElementById("wdlc102").text = "Telusuri Katalog";
    document.getElementById("wdlc103").text = "Schneider IQ";
    document.getElementById("wdlc104").text = "Akademi GSC";
    document.getElementById("wdlc105").text = "Portal Pengembangan Karyawan";
    document.getElementById("wdlc106").text = "Pojok Pembelajaran lintas fungsi";
